    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          child: Stack(
            children: [
              Container(width: screenWidth*0.7, height: screenWidth*0.7, child: FlareActor('assets/arc.flr', animation: animation,)),
              Center(
                child: IconButton(
                key: Key('play_button'),
        ...
        Column(
          ...
          children: [
                ...
                children: [
                  SliderTheme(
                    data: SliderThemeData(
                      ...
                      //thumbColor: Color(0xFFd6dbf4),
                      //thumbColor: Colors.transparent,
                      inactiveTrackColor: Color(0xFFd6dcf4),
            ...
            Text(
              ...
              style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Color(0xFFf2f2fa)),
            ),
          ],
        ),
      ],
